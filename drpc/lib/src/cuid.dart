...
final num _discreteValues = pow(_base, 4);
...
String _hostFingerprint() {
  final int hostId = io.Platform.localHostname.runes.reduce(
    (acc, r) => acc + r,
  );
...
/// cuid returns a short random string suitable for use as a unique identifier
String cuid() {
